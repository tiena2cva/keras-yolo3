...
def _main(annotation_path='train.txt',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--classes', default='data/class.txt')
    parser.add_argument(
        '--anchor', default='keras-yolo3/model_data/yolo_anchors.txt')
    parser.add_argument('--log', default='logs/000/')
    parser.add_argument('--weight', default='pretrained/yolo_weights.h5')
    args = parser.parse_args()

    _main(annotation_path=args.train,
          classes_path=args.classes,
          anchors_path=args.anchor,
          log_dir=args.log,
